...
if __name__ == '__main__':
    ...
    dict_class = {'BENIGN': 0, 'Bot': 1, 'DDoS': 2, 'DoS GoldenEye': 3, 'DoS Hulk': 4, 'DoS Slowhttptest': 5
        , 'DoS slowloris': 6, 'FTP-Patator': 7, 'PortScan': 8, 'SSH-Patator': 9
        , 'Web Attack ï¿½ Brute Force': 10, 'Web Attack ï¿½ XSS': 11}
    ...
    for times1 in range(5):
        ...
        for num_unknowns in range(1, 5):
            ...
            if not isExists:
                ...
                noise_gussian = np.random.normal(0.5, 0.1, (500, 68))
                ...
                noise_uniform = np.random.random((500, 68))
