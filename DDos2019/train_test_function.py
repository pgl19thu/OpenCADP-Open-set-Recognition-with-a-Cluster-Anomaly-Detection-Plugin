...
import numpy as np
import torch
from main_anoamly_all import anomaly_predict2
...
def create_cls(data_training, label_training, cls_path, size_input=71, size_output=2, LR_cls=0.005, Batch_cls=64,
    ...
    if method == 'doc':
        ...
        print('--create and train the cls model:' + cls_path)
...
def test_openids(known_classes, time_dir, MODEL_DIR, test_data, method, thresholds, class_num):
    ...
    anomaly_results = anomaly_predict2(time_dir, test_data, known_classes[class_predict])
